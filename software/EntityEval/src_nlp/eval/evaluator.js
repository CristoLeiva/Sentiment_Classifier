var entity_sentiment = require("./../src_nlp/core/classifier.js");
//var trainer = require("./../src/train/start.js");

var fs = require("fs");
var csv = require("fast-csv");

var stream = fs.createReadStream("./../src_nlp/data/v4/eval.csv");
...
var csvStream = csv()
    .on("data", function(data){
        ...
        var sentimentTest = entity_sentiment(data[2], data[1]);

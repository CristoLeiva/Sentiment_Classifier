...
// service url
var SpotlightUrl = 'http://context.aksw.org/spotlight.php';
...
var process = async(function (sourceText) {
    ...
    try {
        ...
        console.log('error parsing twitter text');
    }
    ...
    if (body.Resources) {
        body.Resources.forEach(function (resource) {
            ...
            if (resource['@types'] && resource['@types'] !== '') {
                ...
                var types = resource['@types'].split(',');
...
var spo = require("./annotator");
spo.process(["Hello my friend I love my Android"])
